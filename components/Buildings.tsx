...
const LAYOUT: Record<string, { col: number; rows: number }> = {
  iaa:                  { col: 8, rows: 3 }, // hero wide
  'industrial-gallery': { col: 8, rows: 3 }, // reserved if re-added later
  'aster-azalea':       { col: 8, rows: 2 },
  'house-in-squares':   { col: 4, rows: 1 }, // spotlight, not used below
...
export default function Buildings() {
  ...
  // Remove spotlight from the collage below
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="mx-auto w-full max-w-7xl px-6 pt-24 md:pt-28 lg:pt-32 pb-16">
        ...
        {/* Desktop collage (spotlight removed) */}
        <section
          className="
